...
/Product_Create">+ Add Product</a><br><br>
        ...
        <table border="1" cellpadding="10" cellspacing="0"> 
            ...
            <tbody>
                <%
                ResultSet rs = (ResultSet) request.getAttribute("data"); if (rs!=null) {
                while(rs.next()){
                %>
                <tr>
    ...
    %>:8080/4SCPJSPServlet/Product_Edit?idprod=<% out.println(rs.getString(1)); 
    %>">Edit</a>
    | <a href="http://<% out.println(request.getServerName()); 
    %>:8080/4SCPJSPServlet /Product_Destroy?idprod=<% out.println(rs.getString(1));
    %>">Delete</a>
                </td>
                </tr>
                <%
