...
public class Product {
    ...
    String sql = "select * from table_adp";
    ...
    String sql = "insert table_adp values(?,?,?,?)"; 
    ...
    {
    Connection con = kon.openConnection();
    String sql = "select * from table_adp where idprod = ?"; 
    PreparedStatement ps = con.prepareStatement(sql); 
    ps.setString(1, this.IDProd);
    ...
    {
    Connection con = kon.openConnection();
    String sql = "update table_adp set nama=?, stok=?, price=? where idprod=?";
    PreparedStatement ps = con.prepareStatement(sql);
    ...
    {
    Connection con = kon.openConnection();
    String sql = "delete from table_adp where idprod = ?"; 
    PreparedStatement ps = con.prepareStatement(sql); 
    ps.setString(1, this.IDProd);
    int res = ps.executeUpdate();
